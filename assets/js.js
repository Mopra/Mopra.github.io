...
(function(){
	...
	$("#player").jAudio({
		playlist: [{
				...
				thumb: mediaDir + "/artworks/01.png",
				trackName: "Den Grimme Ælling",
				trackArtist: "H.C. Andersen",
				trackAlbum: "Single"
		}, {
				file: mediaDir + "/songs/02.mp3",
				thumb: mediaDir + "/artworks/02.png",
				trackName: "Askepot",
				trackArtist: "Brødrende Grimm",
				trackAlbum: "Single"
		}, {
				file: mediaDir + "/songs/03.mp3",
				thumb: mediaDir + "/artworks/03.png",
				trackName: "Snehvide",
				trackArtist: "Brødrende Grimm",
				trackAlbum: "Single"
		}, {
				file: mediaDir + "/songs/04.mp3",
				thumb: mediaDir + "/artworks/04.png",
				trackName: "Tornerose",
				trackArtist: "Brødrende Grimm",
				trackAlbum: "Single"
		}, {
				file: mediaDir + "/songs/05.mp3",
				thumb: mediaDir + "/artworks/05.png",
				trackName: "Den lille havfrue",
				trackArtist: "H.C. Andersen",
				trackAlbum: "Single"
		}, {
				file: mediaDir + "/songs/06.mp3",
				thumb: mediaDir + "/artworks/06.png",
				trackName: "Den standhaftige tingsoldat",
				trackArtist: "H.C. Andersen",
				trackAlbum: "Single"
		},
...
$( "#btn-play" ).click(function() {
  $( "#progress" ).slideToggle( "slow", function() {
    // Animation complete.
  });
});
